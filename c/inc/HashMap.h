 ...
 *
 *  @author Ariel Davidov (arik.davidov@gmail.com)
 * 
 *  @bug No known bugs! 
 */
...
typedef enum MapResult {
	...
	MAP_INV_ARG_ERROR				/**< Out parameter was null		*/
} MapResult;
 ...
 * @retval  MAP_INV_ARG_ERROR if _pKey or _pValue is a null
 * 
 ...
 * @retval  MAP_KEY_NOT_FOUND_ERROR if key not found
 * @retval  MAP_UNINITIALIZED_ERROR
 * @retval  MAP_INV_ARG_ERROR if _pValue is a null
 * 
 * @warning key must be unique and destinct
 */
