...
static Pair* PairCreateAndPush(HashMap* _map, const void* _key, const void* _value)
{
	...
	printf("!LIST_OK: %p\n", (void*)((TestList)bucket->m_head->n_next));
	printf("!LIST_OK: %s\n", (char*)((Pair*)bucket->m_head->n_next))->m_key;
