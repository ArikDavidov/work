...
typedef void (*WelcomeFn)(ClientData* _clientData, void* _context);
typedef size_t (*CallbackFn)(void* _inBuf, size_t _inSize,
	                         void* _outBuf, size_t _outSize, void* _context);
typedef void (*NotifyDisconnectFn)(int _clientId, void* _context);


Server* ServerCreate(uint16_t _port, WelcomeFn _welcome, CallbackFn _appFunc,
