...
UNIT(CTOR_from_char_ptr)
    ...
    strcpy(str, "like dis");
    String_t string(str);
    ASSERT_THAT(strcmp(string.cp(), "like dis") == 0);
    String_t anotherString_t("like dat");
    ASSERT_THAT(strcmp(anotherString_t.cp(), "like dat") == 0);
END_UNIT
...
UNIT(copy_CTOR)
    ...
    ASSERT_THAT(strcmp(second.cp(), "dis is string") == 0);
END_UNIT
...
UNIT(Assignment)
    ...
    ASSERT_THAT(strcmp(second.cp(), "dis is string") == 0);
    second = "and now?";
    ASSERT_THAT(strcmp(second.cp(), "and now?") == 0);
END_UNIT
...
UNIT(ToUpper)
    ...
    str.ToUpper();
    ASSERT_THAT(strcmp(str.cp(), "I WAN7T TO TE~ST S8UM STUFF=") == 0);
END_UNIT
...
UNIT(plus_char_ptr)
    ...
    ASSERT_THAT(strcmp(str.cp(), "we complete each other") == 0);
END_UNIT
...
UNIT(plus_String_t)
    ...
    beg = beg + end;
    ASSERT_THAT(strcmp(beg.cp(), "we complete each other") == 0);
END_UNIT
