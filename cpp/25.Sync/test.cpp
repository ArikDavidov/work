...
UNIT(PushPop)
    ...
    q.Push(std::tr1::shared_ptr<int>(new int(30)), 30);
    q.Push(std::tr1::shared_ptr<int>(new int(90)), 90);
    q.Push(std::tr1::shared_ptr<int>(new int(25)), 25);
    q.Push(std::tr1::shared_ptr<int>(new int(40)), 40);
